...
/* As we can see using "React.createElement" can be so lengthy and hard to read, 
instead of this we can create elements on html, so we use JSX to write HTML like code in our React project. 
*/
